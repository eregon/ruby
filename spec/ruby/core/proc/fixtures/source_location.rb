module ProcSpecs
  class SourceLocation
    MY_PROC_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 2, 19]
    def self.my_proc
      proc { true }
    end
    ...
    MY_BLOCK_LAMBDA_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 2, 19]
    ...
    MY_RETURNED_BLOCK_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 2, 25]
    ...
    MY_RECEIVER_BLOCK_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 2, 31]
    ...
    MY_MULTILINE_PROC_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 5, 9]
    ...
    MY_HEREDOC_PROC_SOURCE_RANGE = [__LINE__ + 2, 6, __LINE__ + 2, 21]
    ...
    MY_FOR_BODY_PROC_SOURCE_RANGE = [__LINE__ + 1, 4, __LINE__ + 3, 7]
    for pr in iter
      42
    end
    MY_FOR_BODY_PROC = pr
