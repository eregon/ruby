...
describe "Integer#chr with an encoding argument" do
  ...
  it "raises RangeError if self is invalid as a codepoint in the specified encoding" do
    ...
    # UTF-16 surrogate range
    -> { 0xD800.chr("UTF-16BE") }.should raise_error(RangeError)
    -> { 0xDBFF.chr("UTF-16BE") }.should raise_error(RangeError)
    -> { 0xDC00.chr("UTF-16BE") }.should raise_error(RangeError)
    -> { 0xDFFF.chr("UTF-16BE") }.should raise_error(RangeError)
  end
